...
class Product
{
  ...
  {
    $products = $this->db->query("SELECT p.* , c.nombre as nombre_categoria FROM productos as p INNER JOIN categorias as c ON p.categoria_id = c.id WHERE p.categoria_id = {$this->getCategory_id()}");
    return $products;
  }
